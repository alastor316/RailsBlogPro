...
ActiveRecord::Schema.define(version: 20180403020746) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.string "coverCat_file_name"
    t.string "coverCat_content_type"
    t.integer "coverCat_file_size"
    t.datetime "coverCat_updated_at"
